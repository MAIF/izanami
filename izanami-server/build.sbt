...
resolvers ++= Seq(
  ...
  "elastic-scala-http-repo" at "https://raw.github.com/larousso/elastic-scala-http/master/repository/releases"
)
...
libraryDependencies ++= Seq(
  ...
  "com.adelegue" %% "playjson-extended" % "0.0.1", // Apache 2.0
  ...
  "com.adelegue" %% "elastic-scala-http" % "0.0.8", // Apache 2.0
