...
package object apikey {
  ...
  object ApikeyDataStore {
    ...
    def live(izanamiConfig: IzanamiConfig): ZLayer[DataStoreLayerContext, Throwable, ApikeyDataStore] =
      JsonDataStore
        .live(izanamiConfig, c => c.apikey.db, InMemoryWithDbStore.apikeyEventAdapter)
