...
class ExperimentVariantEventDynamoServiceTest
// FIXME IT doesn't work

//  extends AbstractExperimentServiceTest("DynamoDb") {
//
...
//  }
//
//  override def dataStore(name: String): ExperimentVariantEventService[IO] = ExperimentVariantEventDynamoService[IO](
//    DynamoConfig(name, name, region, host, port, tls = false, accessKey = Some(accessKey), secretKey = Some(secretKey)),
//    getClient(name),
