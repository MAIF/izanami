...
class Env(
  ...
  lazy val encryptionKey = new SecretKeySpec(
    typedConfiguration.authentication.tokenBodySecret
      .padTo(16, "0")
      .mkString("")
      .take(16)
      .getBytes,
  ...
  val houseKeepingStartDelayInSeconds: Long =
    typedConfiguration.housekeeping.startDelayInSeconds
  ...
  val houseKeepingIntervalInSeconds: Long =
    typedConfiguration.housekeeping.intervalInSeconds
  ...
  val wasmIntegration: WasmIntegration = WasmIntegration(
    new IzanamiWasmIntegrationContext(this)
  )
  val jobs = new Jobs(this)
  private val maybeOidcConfig = typedConfiguration.openid
  ...
  private def oidcConfigurationMigration()
      : FutureEither[Option[FutureEither[FullIzanamiConfiguration]]] = {
