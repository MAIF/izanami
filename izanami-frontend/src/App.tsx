      ...
      <div className="row">
        <nav className="navbar navbar-expand-lg fixed-top p-0">
          ...
          <ul className="navbar-nav ms-auto">
            <li onClick={() => switchLightMode()} className="me-2 d-flex align-items-center">
              <i id="lightMode" className="fa fa-lightbulb" style={{color: "var(--color_level2)", cursor:"pointer"}}/>
            </li>
  ...
  constructor(props: any) {
    ...
    this.state = {
      ...
      askConfirmation: (
        ...
        this.setState({ confirmation: { message: msg, callback: callback } });
      },
