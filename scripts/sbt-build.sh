...
SBT_ARGS=-Dsbt.color=always -Dsbt.supershell=false
...
then
    ...
    then
        ...
        sbt -J-Xmx2G -J-Xss20M -J-XX:ReservedCodeCacheSize=128m ++$TRAVIS_SCALA_VERSION $SBT_ARGS ";test"
        sbt -J-Xmx2G -J-Xss20M -J-XX:ReservedCodeCacheSize=128m ++$TRAVIS_SCALA_VERSION $SBT_ARGS ";it:test"
        sbt -J-Xmx2G -J-Xss20M -J-XX:ReservedCodeCacheSize=128m ++$TRAVIS_SCALA_VERSION $SBT_ARGS ";izanami-server/assembly;izanami-server/dist;izanami-server/docker:publish;jvm/publishLocal;jvm/publish"
        sbt -J-Xmx2G -J-Xss20M -J-XX:ReservedCodeCacheSize=128m ++$TRAVIS_SCALA_VERSION $SBT_ARGS ";jvm/publishLocal;jvm/publish"
    ...
    docker login -u ${DOCKER_USER} -p ${DOCKER_PASSWORD}
    sbt -J-Xmx2G -J-Xss20M -J-XX:ReservedCodeCacheSize=128m ++$TRAVIS_SCALA_VERSION $SBT_ARGS ";izanami-server/assembly;izanami-server/dist;izanami-server/docker:publish;publish"
