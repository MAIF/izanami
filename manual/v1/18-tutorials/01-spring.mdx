---
title: Spring / React tutorial
---

import login from "@site/static/v1/img/tutorial/spring/login.png";
...
![Code](/v1/img/tutorial/spring/code_orga.png) 
...
![Search](/v1/img/tutorial/spring/search.png)

Select it 

![Home](/v1/img/tutorial/spring/home.png)

Go to the episodes to add the watched ones 

![Show](/v1/img/tutorial/spring/ashow.png)
...
![Features](/v1/img/tutorial/spring/features.png)

and click "Add Item" to add your key :

![Features](/v1/img/tutorial/spring/create_feature.png)

Now your keys are created and enabled 

![Features](/v1/img/tutorial/spring/features2.png)
...
![Search](/v1/img/tutorial/spring/tvdb_search.png)


Let's disable tvdb on Izanami : 

![Search](/v1/img/tutorial/spring/tvdb_disabled.png)

We can see this on the log thanks to server sent event : 

![Search](/v1/img/tutorial/spring/disabled_log.png)


Now if we refresh the page and search : 

![Search](/v1/img/tutorial/spring/betaserie_search.png)
...
![Izanami](/v1/img/tutorial/spring/allseasonwatch_feature.png)
...
![Izanami](/v1/img/tutorial/spring/seasonaswatched_disabled.png)


Go to the Izanami server, activate the feature and reload the page 

![Izanami](/v1/img/tutorial/spring/seasonaswatched_enabled.png)
...
![Izanami](/v1/img/tutorial/spring/abtesting_button.png)
...
![Izanami](/v1/img/tutorial/spring/ab_creation.png)

Ok the experiment is created

![Izanami](/v1/img/tutorial/spring/ab_list.png)


If I go the app using the user `floki@gmail.com`, I got the variant A 

![Izanami](/v1/img/tutorial/spring/ab_adisplayed.png)

And with the user `ragnar.lodbrock@gmail.com`, I got the variant B
  
![Izanami](/v1/img/tutorial/spring/ab_bdisplayed.png)


After clicking multiple times on the buttons, the results are 

![Izanami](/v1/img/tutorial/spring/ab_results.png) 
