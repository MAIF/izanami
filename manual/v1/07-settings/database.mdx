...
Other settings are available, consult the [settings](./settings) page.

### Elasticsearch

{/* prettier-ignore */}
<a src="https://www.elastic.co/" target="_blanck">Elasticsearch</a> is an very scalable search engine. This database if well suited for storing
A/B testing events.
...
![InMemoryWithDb](/v1/img/diagrams/inmemorywithdb.png)
