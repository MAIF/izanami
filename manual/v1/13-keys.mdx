---
title: Key definition and best practices
---
...
When you create a user, you can define "authorized patterns" ( [more details here](./ui#edit-a-user) ).
...
This kind of pattern are mandatory if you use the [node](./clients/node) or [jvm](./clients/jvm) clients.
