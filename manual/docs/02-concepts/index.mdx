...
Feature flag logic can be entirely stored in your application, for instance storing flag state in some database.
...
However there is no silver bullets, and centralized feature flag solutions are no exceptions :
...
- If centralized feature flag solution is down, your application can't access flag state anymore (you may define <a href="#" target="_blank">default activation strategies</a> for your features)
...
Realease feature flags are used to keep feature disabled while they are not ready.
...
This could for instance be use to disable feature with high performance impact, or to put part of your information system into maintainance state.
