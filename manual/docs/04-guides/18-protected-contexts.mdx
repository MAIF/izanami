...
<Note>Protected contexts are available from Izanmi 2.9.0</Note>
...
### Indirect protected context update

Protecting a context limit users that can update this context and its overloads directly.

Izanami also make sure that a user without admin rights cannot perform **indirect protected context updates**.

An indirect protected context update is an update that would modify strategy used by a feature for a protected context without updating this context or its overload directly.
