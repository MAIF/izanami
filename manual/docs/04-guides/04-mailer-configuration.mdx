...
To configure mail provider, you need to be Izanami admin. Just go to the "Global Settings" page and setup the mail provider of your choice.
...
Default invitation mode is to display invitation link to the user performing the invitation.

This allows Izanami to work correctly event when no mailer is configure.

It is possible to change this behaviour to make Izanami send these invitation emails.
