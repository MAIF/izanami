...
```json
{
  ...
  "tenants": {
    "my-tenant": {
      ...
      "default-project-right": "<read|write|admin>", // default project right for "my-tenant"
      ...
      "projects": {
        "my-project": "<read|write|admin>", // Specific right level for project "my-project"
        "another-project": "<read|write|admin>" // Specific right level for project "another-project"
      },
      "keys": {
