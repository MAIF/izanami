...
To pass IZANAMI_WORKER_URL_BY_CONTEXTS through env variable, just wrap it in `'`:

```sh
IZANAMI_WORKER_URL_BY_CONTEXTS='{"mytenant": {"prod": "http://prod.com","dev": "http://dev.com","dev/subdev": "http://subdev.com","": "http://default.com"}}'
```

|                            | Environnement variable                | Program argument                | Default     |
| -------------------------- | ------------------------------------- | ------------------------------- | ----------- |
| Worker URL by context      | IZANAMI_WORKER_URL_BY_CONTEXTS        | worker-url-by-contexts          | \{\}          |
