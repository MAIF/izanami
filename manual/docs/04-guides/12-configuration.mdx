...
|                            | Environnement variable                | Program argument                | Default     |
| -------------------------- | ------------------------------------- | ------------------------------- | ----------- |
| Context allowlist          | IZANAMI_CLUSTER_CONTEXT_ALLOWLIST     | app.mode.context-allowlist      | null        |
| Context blocklist          | IZANAMI_CLUSTER_CONTEXT_BLOCKLIST     | app.mode.context-blocklist      | []          |
...
```sh
IZANAMI_WORKER_URL_BY_CONTEXTS='{"prod": "http://prod.com","dev": "http://dev.com","dev/subdev": "http://subdev.com","": "http://default.com"}'
```
