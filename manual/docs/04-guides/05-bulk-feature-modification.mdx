...
Izanami allows to enable / disable or delete multiple features at once.

This is usefull when you want a set of feature to be enabled / disabled at once, or simply to avoid too many clicks.
