...
Fill the form with epxorted files, the form has many options, especially regarding location of imported features.

<Note>
  Default behaviour is to import features in a new project. However Izanami can
...
Once form is validated, Izanami needs some times to process files.

<img src={importConfirmed} />

After that, your feature are imported in designated (or deduced) project(s).
