...
Once invitation is sent, Izanami will either display invitation link or send it to the specified email, based on [your configuration](./04-mailer-configuration.mdx).

If invitation mode is set to "Request response", Izanami will display invitation url **so that you can send it to the concerned user**.
...
Your new user must open the link to define it's username and password.
