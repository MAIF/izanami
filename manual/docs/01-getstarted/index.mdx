...
This image embeds Izanami itself and a postgres database, therefore you don't need any additionnal setup.
...
<Note>
While requesting Izanami directly from HTTP is perfectly fine, it may be a better idea to use [one of our client](../clients), which offers some nice enad built-in resilience and performance features.
</Note>
