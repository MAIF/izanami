...
import tenanForm from "@site/static/img/screenshots/gettingstarted/tenant-form.png";
...
To cover more advanced topics, either refer to <a href="#" target="_blank">documentation</a> or <a href="#" target="_blank">other guides</a>.

## Instantiate Izanami locally

There is several way to start Izanami.
...
Before creating feature, you need to create a tenant and a project.

These two organisations levels will help you keeping thing organized.
...
On this screen there is two choices, we can either create a new project from scratch or import data, for this guide we will create a new project.
If you're interested in importing data, check the <a href="#">data importing guide</a>.
...
<Note>We recommand to create one key by client application</Note>
...
Once your key is created, a popup will display associated secret.

**_You need to copy this secret before closing popup, since it won't be display again_**.

<img src={keySecret} />

After closing the popup, you'll also need to copy clientId from the table.
