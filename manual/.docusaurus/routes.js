...
export default [
  ...
  {
    path: '/izanami/docs',
    component: ComponentCreator('/izanami/docs', 'ba1'),
    routes: [
      {
        path: '/izanami/docs',
        component: ComponentCreator('/izanami/docs', '6d5'),
        routes: [
          {
            path: '/izanami/docs',
            component: ComponentCreator('/izanami/docs', 'f07'),
            routes: [
              {
              ...
              {
                path: '/izanami/docs/guides/oidc-configuration',
                component: ComponentCreator('/izanami/docs/guides/oidc-configuration', '4ea'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/izanami/docs/guides/protected-contexts',
                component: ComponentCreator('/izanami/docs/guides/protected-contexts', '376'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/izanami/docs/guides/stales-features',
                component: ComponentCreator('/izanami/docs/guides/stales-features', 'b01'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/izanami/docs/usages/rights',
                component: ComponentCreator('/izanami/docs/usages/rights', '581'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
